...
#### Задача: "Учет посещаемости студентов"
Условие:
Создать программу для учета посещаемости студентов. Программа должна:

Создавать файл с данными о студентах

Добавлять записи о посещаемости

Показывать статистику посещаемости

Находить студентов с плохой посещаемостью
