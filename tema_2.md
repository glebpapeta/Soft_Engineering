...
1. print(100 + 50) - выводится результат сложения двух целых чисел (тип int)

2. print(10.5 - 3.2) - выводится результат вычитания двух чисел с плавающей точкой (тип float)

3. print(25 + 7.5 - 3.0) - выводится результат смешанных операций с int и float (результат будет float)
